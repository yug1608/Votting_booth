...
<html>
<head>
    <title>ATMIYA VIDYAPEETH - Voting System</title>
    {% raw %}
    <style>
        body {
...
<body>
    ...
    <h1 class="school-title">ATMIYA VIDYAPEETH</h1>

    <div class="container">
        {{ content|safe }}
        <footer>Developed by Yug Singh</footer>
    </div>
...
def home():
    ...
    <form method="POST">
        ...
        <input type="text" name="grno" required><br><br>
        <button type="submit">Start Voting</button>
    </form>
    <br>
    <a href="/admin" style="color: #00c6ff;">Admin Login</a>
    """
...
def vote():
    ...
    content += "<br><button type='submit'>Submit Vote</button></form>"
